...
using Microsoft.ML.Transforms;
    ...
    {
        public const string RetrainFilePath =  @"G:\graduation project\Waslah\WaslahApi\Waslah\Data\taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=402,MinimumExampleCountPerLeaf=35,LearningRate=0.9999997766729865,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.6608993540359621,FeatureFraction=0.99999999,L1Regularization=2.0369384595763354E-09,L2Regularization=0.0378585688830013},MaximumBinCountPerFeature=201}));
